...
<library name="pcb_usb">
<packages>
<package name="PCB_USB_WBACK">
...
<smd name="P$1" x="1.27" y="6.35" dx="4.445" dy="12.7" layer="16"/>
<smd name="P$2" x="6.35" y="6.35" dx="4.445" dy="12.7" layer="16"/>
</package>
...
<text x="2.54" y="30.48" size="1.27" layer="94">PCB USB</text>
<pin name="V" x="-5.08" y="25.4" length="middle"/>
<pin name="DM" x="-5.08" y="20.32" length="middle"/>
<pin name="DP" x="-5.08" y="15.24" length="middle"/>
...
<gates>
<gate name="G$1" symbol="PCB_USB" x="-12.7" y="-17.78"/>
</gates>
<devices>
<device name="WITHBACK" package="PCB_USB_WBACK">
<connects>
...
<device name="NOBACK" package="PCB_USB">
<connects>
<connect gate="G$1" pin="DM" pad="DM"/>
<connect gate="G$1" pin="DP" pad="DP"/>
<connect gate="G$1" pin="GND" pad="GND"/>
...
<part name="U$2" library="pcb_usb" deviceset="PCB_USB" device="NOBACK"/>
...
<instance part="P+1" gate="1" x="22.86" y="109.22" smashed="yes">
...
<instance part="GND1" gate="1" x="22.86" y="66.04" smashed="yes">
...
<wire x1="78.74" y1="101.6" x2="22.86" y2="101.6" width="0.1524" layer="91"/>
